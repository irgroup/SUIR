...
class PredeterminedQueryGeneratorSCPipe(BaseQueryGenerator):
    """
    ...
    """
    def __init__(self, stopword_file, query_file, user, background_file=[], use_filter=True):
        """
        Initialises the class.
        """
        super(PredeterminedQueryGeneratorSCPipe, self).__init__(stopword_file, background_file=[], allow_similar=True)
    ...
    def generate_query_list(self, search_context : SearchContext):
        ...
        search_context.set_filter(self._use_filter)
