...
class SearchContext(object):
    ...
    def get_irrelevant_documents(self):
        """
        Returns a list of irrelevant docuemnts.
        """
    ...
    def get_rel_found_terms(self):
        return self._rel_found_terms
    
    def add_rel_found_terms(self, terms):
        self._rel_found_terms = set(list(self._rel_found_terms) + terms)

    def get_nrel_found_terms(self):
        return self._nrel_found_terms
    
    def add_nrel_found_terms(self, terms):
        self._nrel_found_terms = set(list(self._nrel_found_terms) + terms)

    def get_used_docs(self):
        return self._docs_used_for_keywords
    
    def add_used_doc(self, docid):
        self._docs_used_for_keywords.add(docid)

    def set_filter(self, filter):
        self._search_interface.set_filter(filter, self)
